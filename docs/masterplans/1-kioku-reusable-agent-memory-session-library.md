...
- [ ] EP-3: L2 scene program plus regeneration/timer-arming core exist and L2 timers are routed by
      the worker; L2 CLI/filesystem mirror and L3 persona projections remain
