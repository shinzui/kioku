...
- [ ] EP-3: shikumi/baikai Claude runtime wiring compiles and `MemoryMerged`/`Kioku.Memory.merge`
      exist; L1 atom extraction + LLM consolidation (`store|update|merge|skip`) still needs
      implementation
