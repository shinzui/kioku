...
- [ ] EP-3: shikumi/baikai Claude runtime wiring compiles; L1 atom extraction + LLM consolidation
      (`store|update|merge|skip`) recorded as events still needs implementation
